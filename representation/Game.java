...
/**
 * La classe Game représente le moteur principal du jeu Divergente. Elle gère le déroulement
 * du jeu, les épreuves, les personnages et les sauvegardes.
 *
 * @author Rachelle NASR et Lysa RABIA
 */
...
public class Game {
	...
	public static String nomFichier = "./sauvegarde.csv";
	  ...
	  /**
     * Constructeur de la classe Game qui initialise les personnages possibles et les épreuves du jeu.
     *
     * @param scanner Scanner pour la lecture des entrées utilisateur.
     */

	public Game(Scanner scanner) {
		this.persoPossibles = new Personnage[5];
		// Initialisation des personnages possibles
		this.persoPossibles[0] = new Personnage("Antoine ", 0, 0, 1, 4, 1,
				"au coeur genereux, se distingue par son empathie et son attitude \n"
						+ " bienveillante envers les autres. Ses actions désintéressées et son\n"
						+ " inclination naturelle à soutenir ceux qui l'entourent soulignent son\n"
						+ " attachement profond aux liens humains. Sa façon chaleureuse d'interagir\n"
						+ " avec les autres, ponctuée de gestes attentionnés, trahit une prédisposition \n"
						+ "à la fraternité.\n",
				null);
		this.persoPossibles[1] = new Personnage("Christina", 0, 4, 0, 1, 0,
				" Christina, au premier abord, semble être une personne qui apprécie l'exploration \n"
						+ "et l'expérience de nouvelles choses. Sa curiosité la pousse à chercher des défis \n"
						+ "et des situations qui mettent ses compétences à l'epreuve. Elle ne craint pas \n"
						+ "l'inconnu et est souvent vue en train d'explorer des territoires inexplores.\n",
				null);

		this.persoPossibles[2] = new Personnage("Emily", 4, 0, 1, 0, 0,
				" discrète et bienveillante, semble constamment préoccupée par le bien-être des autres. \n"
						+ "Son attitude chaleureuse et son sourire doux indiquent une sensibilite particuliere envers \n"
						+ "les émotions des gens qui l'entourent.Son choix vestimentaire privilégie souvent des tons apaisants,\n"
						+ " reflétant son désir d'harmonie et de compassion.\n",
				null);

		this.persoPossibles[3] = new Personnage("Julien", 1, 0, 4, 0, 0,
				" , toujours avide de connaissances, se plonge sans cesse dans les livres et explore le monde avec une soif\n"
						+ " insatiable d'apprendre. Son esprit curieux et analytique révèle une passion profonde pour la recherche de la\n"
						+ " vérité et la quete du savoir. Ses conversations sont teintées d'une intelligence perceptible, et ses choix sont\n"
						+ " guides par une volonte constante d'approfondir sa comprehension du monde qui l'entoure\n",
				null);

		this.persoPossibles[4] = new Personnage("Sophie", 0, 1, 0, 0, 4,
				" , avec son regard direct et son langage non équivoque, laisse transparaître une honnêteté qui ne tolère guère\n"
						+ " les faux-semblants. Sa manière de s'exprimer, sans artifices ni détours, dénote une sincérité profonde. \n"
						+ "Les nuances subtiles de ses expressions faciales révèlent une transparence émotionnelle, soulignant son engagement \n"
						+ "envers l'authenticité. Un style vestimentaire simple mais élégant suggère qu'elle accorde de l'importance à l'expression\n"
						+ " véritable de soi.\n",
				null);
	 ...
	 *
	 * @param nomFichier Le nom du fichier contenant les sauvegardes.
	 * @param console    Scanner pour la lecture des entrées utilisateur.
	...
	public void sauvegarderPartie(String nomSauvegarde) throws IOException {
	 ...
	 /**
     * Initialise les épreuves du jeu.
     *
     * @param scanner Scanner pour la lecture des entrées utilisateur.
     */
	...
	public void initEpreuve(Scanner scanner) {
		...
		DecisionNode premiereEpreuve = new DecisionNode(
				"Vous savourez une gorgée du mystérieux sérum qui coule dans vos veines, imprégnant chaque\n"
						...
						+ "votre conscience s'embrouille, vous plongeant dans un rêve éthéré.\n"
						+ "Dans ce rêve, vous vous tenez devant cinq paniers, chaque objet révélant une essence unique.\n "
						+ "Un choix crucial s'offre à vous\n" + "1. un couteau\n" + "2. un morceau de fromage\n"
						+ "3. un livre\n" + "4. une écharpe\n" + "5. un journal intime\n",
		...
		DecisionNode ChoixCouteau = new DecisionNode(
				"Un couteau, symbole de puissance et de protection, se trouve desormais en votre possession \n"
						+ "et vous conduit à une épreuve inattendue. Soudain, un chien surgit, les crocs découverts,\n"
						+ " prêt à l'attaque. Devant vous, une porte mystérieuse, 2 choix se presentent a vous \n"
		...
		DecisionNode ChoixFromage = new DecisionNode(
				"En votre possession un fromage, symbole de partage et de subsistance, vous conduit à\n"
						+ " une situation délicate. Alors que vous errez, vous retrouvez d'anciens camarades, mais\n"
						+ " la scène qui se dévoile est loin d'être réjouissante. Plusieurs d'entre eux sont blessés, \n"
						+ "nécessitant une aide immédiate. Au détour de votre chemin, vous découvrez un groupe de connaissances\n"
						+ " qui détiennent des médicaments salvateurs.\n"
		...
		DecisionNode ChoixLivre = new DecisionNode(
				"Un livre se trouve desormais en votre possession, symbole de connaissance et de sagesse, \n"
						+ "vous place face à un défi inattendu. Alors que vous avancez, un chien menaçant surgit,\n"
		...
		DecisionNode ChoixEcharpe = new DecisionNode(
				"Une echarpe, symbole de chaleur et de réconfort, se trouve desormais en votre possession,\n"
						+ " et vous conduit à une rencontre inattendue. Alors que vous marchez, un vent glacial s'abat \n"
						+ "sur la ville. Cependant, grâce à votre écharpe, vous restez au chaud.\n"
		...
		DecisionNode ChoixJournal = new DecisionNode(
				" Votre choix du journal intime, un moyen d'expression personnelle et d'authenticité, vous amène \n"
						+ "à une situation inhabituelle. Vous vous retrouvez sur une estrade, face à un grand public, où \n"
						+ "chacun lit à tour de rôle son journal intime. Dans ce moment de partage intime, deux options \n"
						+ "se présentent à vous, révélant votre approche face à la mise en lumière de votre vie privée.\n"
		...
		DecisionNode ChoixFacS = new DecisionNode(
				...
				"Soudainement, tout s'efface autour de vous. L'environnement change radicalement, et vous vous \n"
						+ "retrouvez dans un bus. Sans argent ni ticket, le chauffeur vous fixe droit dans les yeux et vous \n"
						+ "interroge sur la possession d'un ticket. Devant cette situation délicate, deux options se présentent\n"
						+ "à vous, révélant votre attitude face à l'éthique et à la légalité dans un monde où les choix peuvent \n"
		...
		DecisionNode ChoixAl = new DecisionNode(
				"Vous peinez à trouver une place, cependant, au moment ou vous vous asseyez, une vieille dame \n"
		...
		DecisionNode ChoixEr = new DecisionNode(
				...
				"Alors que vous vous installez dans le bus, vous découvrez un mystérieux carnet contenant des énigmes\n"
						+ " complexes et intrigantes. Chaque page semble renfermer des secrets mathématiques fascinants. \n"
		...
		DecisionNode ChoixFr = new DecisionNode(
				"Votre personnage repère un groupe de personnes rassemblées dans un coin du bus, discutant \n"
						+ "et riant ensemble. Deux choix s'offrent à lui :\n"
		...
		DecisionNode ChoixFuite = new DecisionNode("Vous avez decide de fuir et n'avez pas ete à la hauteur. \n "
				+ "Cependant, le destin a decide de vous octroyer une seconde chance \n "

				+ " Appuyez 1 pour continuer\n", 1, i++, 0, 0, 0, 0, 0, null, scanner);
		dictionnaireNode.put(ChoixFuite.getId(), ChoixFuite);

		DecisionNode ZoneAudacieux = new DecisionNode(
				"Dans la Zone des Audacieux, face à un mur imposant, deux potions s'offrent à vous, choisissez avec sagesse,\n"
						+ " votre décision impacte votre destinée et la perception de votre courage par les évaluateurs :\n"
		...
		DecisionNode ZoneAltruiste = new DecisionNode(
				"Vous entrez dans la Zone des Altruistes, où des choix difficiles mettent en jeu le bien-être des autres participants.\n "
						+ "À un moment crucial, optez :\n" + "\n"
						+ "1. Sacrifier une partie de vos ressources pour aider un autre, démontrant l'altruisme,\n"
		...
		DecisionNode ZoneErudit = new DecisionNode(
				"Vous entrez dans la Zone des Érudits, remplie d'énigmes complexes. À un moment crucial, choisissez :\n"
						+ "\n"
						+ "1. Résoudre une énigme individuellement, mettant en avant votre intelligence personnelle, \n"
		...
		DecisionNode ZoneFraternels = new DecisionNode(
				"Vous entrez dans la Zone des Fraternels, où des choix moraux mettent en jeu la loyauté envers \n"
						+ "vos compagnons de faction. À un moment crucial, vous devez opter :\n" + "\n"
		...
		DecisionNode ZoneSincere = new DecisionNode(
				"Vous entrez dans la Zone des Sincères, remplie de miroirs déformants et d'illusions. À un moment crucial, \n"
						+ "choisissez :\n" + "\n"
						+ "1. Suivre le chemin de la vérité, identifiant les illusions avec honnêtet\n"
		...
		DecisionNode FactionAl = new DecisionNode(
				"Bienvenue parmi les Altruistes, là où la solidarité et l'empathie sont nos valeurs principales. \n"
		...
		DecisionNode FactionSinc = new DecisionNode(
				"Bienvenue parmi les Sincères, où l'authenticité et la vérité sont nos guides.\n"
						+ "Devant vous se deroule une partie d'undercover entre 4 personnes,\n"
						+ "parmi eux, 1 undercover et 3 civils. \n" + "1. : Abeille \n" + "2. : Toux \n"
						+ "3. : Pancakes \n" + "4. : Erable \n" + "Qui est l'undercover ?",
				4, i + 5, 0, 0, 0, 0, 3, outil, scanner);
		dictionnaireNode.put(FactionSinc.getId(), FactionSinc);

		TerminalNode Divergent = new TerminalNode(
				"Tes choix audacieux et divergents ont tracé un chemin unique, mais dans le monde\n"
						+ " implacable de Divergent, la divergence a un prix. Les dirigeants, intolérants envers\n"
						+ " la déviation, ont scellé ton destin. Ta partie s'achève ici. \n"
						+ "Affronte les conséquences de ta divergence.\n",
				i + 6);
		dictionnaireNode.put(Divergent.getId(), Divergent);

		ChoixFaction choixFaction = new ChoixFaction(currentPerso, " ", FactionAl, FactionAud, FactionEr, FactionFr,
				FactionSinc, Divergent, 6, i++, 0, 0, 0, 0, 0, outil);
		dictionnaireNode.put(choixFaction.getId(), choixFaction);

		i += 6;

		DecisionNode Ep2Al = new DecisionNode(
				"Bienvenue, Altruiste, dans cette deuxième épreuve qui mettra à l'épreuve votre compréhension \n"
						+ "des valeurs fondamentales qui vous animent. L'énigme que vous avez devant vous résonne avec \n"
						+ "l'esprit du partage, de la compassion et de la solidarité.\n" + "\n"
		...
		DecisionNode Ep2Fr = new DecisionNode(
				"Cette épreuve met en avant l'importance pour les Fraternels de comprendre les nuances du \n"
						+ "commerce équitable. En ayant une connaissance approfondie des calculs commerciaux de base, \n"
						+ "les Fraternels peuvent contribuer de manière significative à la prospérité de leur faction\n"
						+ " et à l'équilibre économique global.\n"
						+ "Vous avez devant vous une situation commerciale typique. Le prix d'achat d'un produit est de 150€, \n"
						+ "et les frais d'achat s'élèvent à 8%. Votre tâche est de calculer le coût d'achat total du produit en \n"
						+ "tenant compte des frais.Options :\n" + "\n" + "125€\n" + "136,50€\n" + "150€\n" + "162€\n"
						+ "",
				4, i++, 0, 0, 0, 3, 0, outil, scanner);
		dictionnaireNode.put(Ep2Fr.getId(), Ep2Fr);

		DecisionNode Ep2S = new DecisionNode(
				"Bienvenue dans cette 2e épreuve, où tu démontreras ta maîtrise des mots et ta capacité\n"
						+ " à choisir les termes justes. Les Sincères, connus pour leur éloquence, savent que la parole\n"
						+ " a un impact immense. Prêt à faire résonner la sincérité dans chaque syllabe ?\n "
		...
		DecisionNode Ep2R = new DecisionNode(
				"Bienvenue dans le défi du Mastermind Carré ! Dévoilez vos talents stratégiques en tentant de décrypter\n"
						+ " la combinaison secrète de chiffres, avec quatre chiffres par ligne sur quatre lignes. \n"
		...
		DecisionNode Ep2Aud = new DecisionNode(
				"Les Audacieux, connus pour leur bravoure et leur capacité à prendre des risques calculés, doivent \n"
						+ "démontrer leur agilité mentale pour triompher de cette épreuve. Cette épreuve met en lumière l'importance \n"
						+ "du \n positionnement stratégique, une compétence essentielle pour les Audacieux \n"
						+ "Devant vous se trouvent Marc, Antoine, et Pierre, chacun d'eux dans une position différente. \n"
		...
		DecisionNode Ep3R = new DecisionNode(
				"Érudit, prépare toi à mettre tes capacités de résolution de problèmes à l'épreuve. \n"
		...
		DecisionNode Ep3Al = new DecisionNode(
				"Bienvenue à la troisieme épreuve, cher Altruiste. Cette épreuve mettra à l'épreuve ta capacité à résoudre\n"
						+ " des situations complexes. Voici l'énigme qui te sera soumise :\n" + "\n"
						+ "Une personne en voiture s'engage dans une rue à sens unique, des policiers l'arrêtent, lui demandent ses papiers,\n"
						+ " mais il repart sans problèmes. Pourquoi ?\n" + "\n"
		...
		DecisionNode Ep3Aud = new DecisionNode(
				"Dans un environnement stimulant, l'épreuve teste leur capacité à prendre des risques calculés même dans des situations \n"
						+ "qui demandent de la rapidité et de l'intrépidité. Bienvenue dans cette epreuve du temps : \n"
		...
		DecisionNode Ep3Fr = new DecisionNode(
				"Bienvenue, Fraternel dans cette 3 eme epreuve, au cours de laquelle nous mettrons à l'epreuve ta connaissance de tes freres. \n "
						+ "- A est le père de B \n" + "- C est la fille de A \n" + "- D est la soeur de E \n"
						+ "- E est le fils de B \n" + "Qui est le grand-père de D?" + "Options : \n" + "1. A" + "2. B"
						+ "3. C" + "4. E",
				4, i++, 0, 0, 3, 0, 0, outil, scanner);
		dictionnaireNode.put(Ep3Fr.getId(), Ep3Fr);

		DecisionNode Ep3S = new DecisionNode(
				"Bienvenue dans cette épreuve, où ton discernement sera mis à l'épreuve. Les Sincères, maîtres de la vérité,\n"
						+ " comprennent l'importance de faire des distinctions subtiles. Dans un monde où chaque mot compte, \n"
						+ "identifier l'intrus est une compétence cruciale. Quel est l'intrus?\n" + "1. Firme\n"
						+ "2. Entreprise\n" + "3. Établissement\n" + "4. Commercial\n" + "5. Société\n" + " ",
				5, i++, 0, 0, 0, 0, 3, outil, scanner);
		dictionnaireNode.put(Ep3S.getId(), Ep3S);

		DecisionNode Ep4Al = new DecisionNode(
				"Ton personnage altruiste se trouve confronté à une situation où il doit transporter de l'eau sans utiliser de récipient. \n"
						+ "Ses qualités altruistes peuvent-elles lui fournir une solution ingénieuse ?\n" + "\n"
		...
		DecisionNode Ep4Aud = new DecisionNode("Bienvenue, Audacieux, dans l'Épreuve de Vitesse Extrême !\n"
				+ "Imagine-toi en pleine action, prêt à défier les lois de la physique. Ton défi est de convertir une vitesse\n"
				+ " de 54 km/h en m/s. Oui, tu as bien entendu, une mission de conversion de chiffres où chaque seconde compte.\n"
		...
		DecisionNode Ep4Fr = new DecisionNode(
				"Bienvenue à cette épreuve fraternelle où les compétences en commerce et en gestion fingradeancière sont mises à "
						...
						+ "Choisis judicieusement parmi les options pour maximiser le bénéfice, " + "1. 1 037.5€\n"
						+ "2. 1 040.0€\n" + "3. 1 042.5€\n" + "4. 1 045.0€",
				4, i++, 0, 0, 0, 3, 0, outil, scanner);
		dictionnaireNode.put(Ep4S.getId(), Ep4S);

		DecisionNode Ep4R = new DecisionNode(
				"Bienvenue à l'épreuve érudite, où la maîtrise des calculs complexes est la clé du succès. \n"
						+ "Imagine que tu te trouves au cœur de la bibliothèque érudite, entouré de connaissances profondes.\n"
						+ " Calcule avec précision (4√2)² pour démontrer ton intelligence exceptionnelle.\n" + "\n"
						+ "Options :\n" + "1. 8\n" + "2. 16\n" + "3. 32\n" + "4. 64\n",
				4, i++, 0, 0, 3, 0, 0, outil, scanner);
		...
		DecisionNode Ep5S = new DecisionNode(
				"Bienvenue à cette épreuve, où la logique et les relations sémantiques te mettront à l'épreuve.\n"
						+ " Les Sincères, experts en communication, comprennent l'importance des associations précises. \n"
		...
		DecisionNode Ep5Fr = new DecisionNode(
				"Bienvenue à cette épreuve fraternelle où les compétences en agriculture et en calcul sont à l'honneur. \n"
						+ "Les Fraternels, maîtres des champs, doivent également exceller dans les domaines mathématiques. \n"
						+ "Imagine que tu cultives un champ avec un cercle de rayon r = 5 m. Calcule l'aire du cercle pour maximiser\n"
						+ " la productivité agricole. Choisis judicieusement parmi les options pour démontrer la force intellectuelle\n"
		...
		DecisionNode Ep5R = new DecisionNode(
				"Bienvenue dans le défi érudit, où la résolution d'équations complexes mettra à l'épreuve ta sagacité.\n"
						...
						+ " Détermine la valeur de X dans l'équation suivante : \n" + " √80 = 2√X \n" + "Options :\n"
						+ "1. 5\n" + "2. 10\n" + "3. 20\n" + "4. 40\n",
				4, i++, 0, 0, 3, 0, 0, outil, scanner);
		...
		TerminalNode Novice = new TerminalNode("Helas, la partie se termine pour toi ! \n"
				+ "Tu as obtenu le grade de Novice, tu feras mieux la prochaine fois, à bientot ! \n", i++);
		dictionnaireNode.put(Novice.getId(), Novice);

		TerminalNode Apprentice = new TerminalNode("Helas, la partie se termine pour toi ! \n"
				+ "Tu as obtenu le grade d'Apprenti, tu feras mieux la prochaine fois, à bientot !\n ", i++);
		dictionnaireNode.put(Apprentice.getId(), Apprentice);

		TerminalNode Journeyman = new TerminalNode(
				"Helas, la partie se termine pour toi ! \n"
						+ "Tu as obtenu le grade de Journeyman , tu feras mieux la prochaine fois, à bientot !\n ",
				i++);
		...
		ChoixGrade fingrade = new ChoixGrade(currentPerso, " ", fin, Novice, Apprentice, Journeyman, Master, Expert, 6,
				i++, 0, 0, 0, 0, 0, outil);
		...
		ChoixFuite.setOptions(List.of(ChoixFacS));
